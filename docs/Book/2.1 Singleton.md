...
Singleton giải quyết bằng cách đảm bảo chỉ tạo duy nhất một thể hiện trong toàn bộ chương trình, thông qua:

- Private constructor để ngăn khởi tạo trực tiếp
- Biến static lưu trữ duy nhất một instance
- Phương thức static getInstance() để trả về instance đó
