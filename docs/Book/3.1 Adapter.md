...
> [!WARNING]
> * Bài này sẽ được cập nhât ở [github sau](https://github.com/nguyenphuc22/Design-Patterns/blob/main/Writerside/topics/Adapter.md) và [website sau](https://nguyenphuc22.github.io/Design-Patterns/adapter.html).
