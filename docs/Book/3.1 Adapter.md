...
Adapter Pattern cho phép hai đối tượng có interface không tương thích có thể làm việc cùng nhau thông qua một lớp trung gian. Đây là một kỹ thuật giúp tích hợp hoặc kết nối các hệ thống có sẵn mà không cần phải sửa đổi chúng.
